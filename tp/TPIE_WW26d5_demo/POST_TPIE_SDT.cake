<Cake OriginalMD5="bf0a4619dbc0995dbf2b6492e5849454" CurrentMD5="4072706df7e1ee3830d78eaabc0df144" SaveUser="jthwing" LastSaveTime="4/13/2021 10:10:25 PM">
<Settings>
...
namespace Scripting
{
    ...
    public class GlobalConfigScript : ScriptGlobalsMethodBase
    {
        ...
        static public void Main(string[] args)
        {
            ...
            currentFolder = @"L:\jthwing\MTL_CPU28\SDT\SDT_Base1_Cake_testing2";
                ...
                GlobalConfigs GlobalConfigDebug = new GlobalConfigs()  {{@"MinVersion", @"1.3.4.351"}, {@"Socket", @"SDT"}, {@"Product", @"MTL_GCD64"}, {@"STPLFILE", @"Default"}, {@"TPLFILE", @"Default"}, {@"ENVFILE", @"Default"}, {@"SOCKET", @"Default"}, {@"TOSVERSION", @"Default"}, {@"Subfamily", @"Default"}, {@"BOMGROUP", @"Default"}, {@"PROGRAMTYPE", @"Default"}, {@"BASETPNAME", @"Default"}, {@"DEVICE", @"Default"}, {@"FuseRootDir", @"Default"}, {@"PLISTFILE", @"Default"}, {@"DEDC", @"Default"}, {@"SOCKETFILE", @"Default"}, {@"USRVFILE", @"UservarDefinitions.usrv"}};
        ...
        private const string Owner = @"shawn.d.pierce@intel.com";
        ...
        public override Cake.Scripting.ScriptReply ExecuteGlobalUpdate(ScriptReply reply, ref GlobalConfigs GlobalConfig)
        {
            ...
            try
            {
                ...
                using (TPIE_Report tpr = new TPIE_Report(ref reply, TPIEReportFile))
                {
                    ...
                    if (DateTime.TryParse(tpr.ProgramReleaseDate, out releaseDate))
                    {
                        if (DateTime.Today &gt; releaseDate.Date)
                        {
                ...
                //Remove any Extra files not needed as defined in the Product setup above
                //foreach (var badFile in invalidFiles)
                //{
                //    try
                //    {
        ...
        private static void Update(ref ScriptReply reply, string minVersion, string msiPath, string executingScript)
        {
            ...
            Cake.Scripting.ScriptingUtilities.Mail("smtp.intel.com", "Cake@intel.com", Owner, string.Format("Cake Update staring: User: {0}, Assembly: [{1}], MSI: {2}", System.Security.Principal.WindowsIdentity.GetCurrent().Name, "Unknown", msiPath));
    ...
    public class SupersedeFilesFromInputs : ScriptMethodBase
    {
        ...
        static public void Main(string[] args)
        {
            ...
            ScriptReply reply = new SupersedeFilesFromInputs //Update this to Match Script Name above for debug in VS
            {
                ...
                //WARNING: Do Not Edit the following line or add additional lines before the closing line (They will be removed), change the Global Variables and Edit the script again to update
                GlobalConfig = new GlobalConfigs() {{@"MinVersion", @"1.3.4.287"}, {@"Socket", @"SDS"}, {@"Product", @"DG1"}, {@"STPLFILE", @"Default"}, {@"TPLFILE", @"Default"}, {@"ENVFILE", @"Default"}, {@"SOCKET", @"Default"}, {@"TOSVERSION", @"Default"}, {@"Subfamily", @"Default"}, {@"BOMGROUP", @"Default"}, {@"PROGRAMTYPE", @"Default"}, {@"BASETPNAME", @"Default"}, {@"DEVICE", @"Default"}, {@"FuseRootDir", @"Default"}, {@"PLISTFILE", @"Default"}, {@"DEDC", @"Default"}, {@"SOCKETFILE", @"Default"}}
...
namespace Scripting
{
    ...
    public class POWERTRC: ScriptMethodBase
    {
        ...
        {
            //When Doing Debug Set to a location containing what you are debugging
            currentFolder = @"I:\program\1274\eng\hdmtprogs\dg1_sds\kkutty\TRC\11";
        ...
        public override ScriptReply ExecuteVerify(ScriptReply reply)
        {
            ...
            try
            {
                ...
                TRCSuite.TRCFlowOrder(Path.Combine(currentFolder, "TRC_Flow_SDT.config"));
                TRCSuite.TRCNaming(Path.Combine(currentFolder, "TRCInstanceName_SDT.xml"));
                ...
                #region PLT TRC
                string goldPins = Path.Combine(currentFolder, "PVF_TRC_Golden.txt");
                ...
                List&lt;string&gt; ignoreEnableClockPinsFromDomainCheck = new List&lt;string&gt;() { "CHIPLET_CLOCK_hpc", "DFTRING_CLK_ec", "TCLK_ec" };
                ...
                // TRC 11-14: General, Python, HVQK, VIPR checks
    ...
    public class Sprinkles : ScriptMethodBase
    {
        ...
        static public void Main(string[] args)
        {
            ...
            ScriptReply reply = new Sprinkles //Update this to Match Script Name above for debug in VS
            {
                ...
                //These Globals can be accessed in Veriy or execute by calling GlobalConfig.GetValuebyKey("KEY","DefaultValue");
                //WARNING: Do Not Edit the following line or add additional lines before the closing line (They will be removed), change the Global Variables and Edit the script again to update
                GlobalConfig = new GlobalConfigs() {{@"Socket", @"SDS"}, {@"Product", @"ICL"}, {@"STPL", @"SubTestPlan_SORT_ICL42MB.stpl"}, {@"TPL", @"BaseTestPlan.tpl"}, {@"MinVersion", @"1.3.4.251"}, {@"TOSVersion31", @"true"}, {@"SubFamily", @"ICL42MB"}, {@"BOMGroup", @"SDS_ICL42MB"}, {@"DieType", @"ICL42MB"}, {@"SocketFile", @"Sort_U42_X1.soc"}, {@"LevelsFile", @"LevelsSequences.lvl"}, {@"ProgramType", @"Uninitialized"}, {@"FuseRootDir", @"Default"}, {@"BaseTPName", @""}, {@"Device", @"Default"}, {@"Stepping", @"A0"}, {@"UservarsDef", @"UservarDefinitions.usrv"}, {@"BaseLevels", @"BaseLevels.tcg"}, {@"PinDefinitions", @"PinDefinitions.pin"}, {@"ProgramFlowsTestPlan", @"ProgramFlowsTestPlan\ProgramFlows.tpl"}, {@"DEDC", @"0"}}
            }.Run(true); //Call Script Verify and then Execute via the .Run Extension Method
        }
    ...
    public class ForceFlow_TRC : ScriptMethodBase
    {
         ...
         static public void Main(string[] args)
        {
            ...
            ScriptReply reply = new ForceFlow_TRC //Update this to Match Script Name above for debug in VS
            {
                ...
                //These Globals can be accessed in Veriy or execute by calling GlobalConfig.GetValuebyKey("KEY","DefaultValue");
                //WARNING: Do Not Edit the following line or add additional lines before the closing line (They will be removed), change the Global Variables and Edit the script again to update
                GlobalConfig = new GlobalConfigs() {{@"MinVersion", @"1.3.4.269"}, {@"Socket", @"SDS"}, {@"Product", @"DG1"}, {@"STPLFILE", @"SubTestPlan_DG1_A0_Dummy.stpl" }, {@"TPLFILE", @"Default"}, {@"ENVFILE", @"Default"}, {@"SOCKET", @"Default"}, {@"TOSVERSION", @"Default"}, {@"Subfamily", @"Default"}, {@"BOMGROUP", @"Default"}, {@"PROGRAMTYPE", @"Default"}, {@"BASETPNAME", @"Default"}, {@"DEVICE", @"Default"}, {@"FuseRootDir", @"Default"}, {@"PLISTFILE", @"Default"}, {@"DEDC", @"Default"}, {@"SOCKETFILE", @"Default"}}
            }.Run(true); //Call Script Verify and then Execute via the .Run Extension Method
        }
    ...
    public class FuseConfigTRC : ScriptMethodBase
    {
        ...
        static public void Main(string[] args)
        {
            ...
            ScriptReply reply = new FuseConfigTRC //Update this to Match Script Name above for debug in VS
            {
                ...
                //These Globals can be accessed in Veriy or execute by calling GlobalConfig.GetValuebyKey("KEY","DefaultValue");
                //WARNING: Do Not Edit the following line or add additional lines before the closing line (They will be removed), change the Global Variables and Edit the script again to update
                GlobalConfig = new GlobalConfigs() {{@"MinVersion", @"1.3.4.294"}, {@"Socket", @"SDS"}, {@"Product", @"DG1"}, {@"STPLFILE", @"Default"}, {@"TPLFILE", @"Default"}, {@"ENVFILE", @"Default"}, {@"SOCKET", @"Default"}, {@"TOSVERSION", @"Default"}, {@"Subfamily", @"Default"}, {@"BOMGROUP", @"Default"}, {@"PROGRAMTYPE", @"Default"}, {@"BASETPNAME", @"Default"}, {@"DEVICE", @"Default"}, {@"FuseRootDir", @"Default"}, {@"PLISTFILE", @"Default"}, {@"DEDC", @"Default"}, {@"SOCKETFILE", @"Default"}}
            }.Run(true); //Call Script Verify and then Execute via the .Run Extension Method
        }
...
{
    //Update the ClassName to your specific Script Name
    public class Fix_BinMatrix : ScriptMethodBase
    {
        ...
        {
            //When Doing Debug Set to a location containing what you are debugging
            currentFolder = @"C:\Users\prmckinn\Desktop\SPR_SDT_BASE_C2X";

            //Main is called during debug in visual studio as the entry point to the script, it is not required in the final Script
            ScriptReply reply = new Fix_BinMatrix //Update this to Match Script Name above for debug in VS
            {
                //Define any GlobalConfigurations using collection initializer here when running the script from Visual Studio
                //These Globals can be accessed in Veriy or execute by calling GlobalConfig.GetValuebyKey("KEY","DefaultValue");
                //WARNING: Do Not Edit the following line or add additional lines before the closing line (They will be removed), change the Global Variables and Edit the script again to update
                GlobalConfig = new GlobalConfigs() { { @"MinVersion", @"1.3.4.321" }, { @"Socket", @"SDT" }, { @"Product", @"SPR" }, { @"STPLFILE", @"Default" }, { @"TPLFILE", @"Default" }, { @"ENVFILE", @"Default" }, { @"SOCKET", @"Default" }, { @"TOSVERSION", @"Default" }, { @"Subfamily", @"Default" }, { @"BOMGROUP", @"Default" }, { @"PROGRAMTYPE", @"Default" }, { @"BASETPNAME", @"Default" }, { @"DEVICE", @"Default" }, { @"FuseRootDir", @"Default" }, { @"PLISTFILE", @"Default" }, { @"DEDC", @"Default" }, { @"SOCKETFILE", @"Default" } }
            }.Run(true); //Call Script Verify and then Execute via the .Run Extension Method
        }

        //When the Hosting script pulls the description this is what it is pulling. This is required by the Scripting Interface ScriptMethodBase
        public override string Description { get { return "PLIST_Updater used to add a dummy plist if there are no plists defined"; } }
        ...
        public override ScriptReply ExecuteVerify(ScriptReply reply)
        {
            ...
            try
            {
                //Can we script the PLIST XML creation
                foreach (var file in new List&lt;string&gt;() { "BinMatrix.xml" })
                {
                    string xmlfilesys = Path.Combine(currentFolder, file);

                    StreamReader reader = new StreamReader(xmlfilesys);
                    string content = reader.ReadToEnd();
                    reader.Close();

                    // Remove any line containing "olb_bin_type"
                    content = Regex.Replace(content, @".*olb_bin_type.*\r*\n*", "");

                    StreamWriter writer = new StreamWriter(xmlfilesys);
