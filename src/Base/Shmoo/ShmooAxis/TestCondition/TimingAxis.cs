...
namespace Prime.TestMethods.Shmoo
{
    ...
    /// <summary>
    /// TimingTestCondition version of axis.
    /// </summary>
    [Serializable]
    internal class TimingAxis : TestConditionAxis
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TimingAxis"/> class.
        /// </summary>
        /// <param name="axisParameter">name of parameter that axis is made of.</param>
        /// <param name="testConditionName">input timing test condition.</param>
        ...
        public TimingAxis(string axisParameter, string testConditionName, PrimeShmooTestMethod.UnitPrefixForDatalog unitPrefixForDatalog, string nameForDatalog)
        ...
        {
            functionalTest.ApplyTimingTestCondition();
        }
