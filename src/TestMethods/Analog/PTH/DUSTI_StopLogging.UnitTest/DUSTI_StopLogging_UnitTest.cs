...
namespace DUSTI_StopLogging.UnitTest
{
    using System;
    ...
    /// </summary>
    [TestClass]
    public class DUSTI_StopLogging_UnitTest
    {
        ...
        /// </summary>
        [TestMethod]
        public void Verify_Levels_Present_Fail_SL()
        {
            DUSTI_StopLogging testing = new DUSTI_StopLogging()
            {
        ...
        /// </summary>
        [TestMethod]
        public void Verify_PinName_Present_Fail_SL()
        {
            DUSTI_StopLogging testing = new DUSTI_StopLogging()
            {
                LevelsOption = "levels",
        ...
        /// </summary>
        [TestMethod]
        public void Verify_ForceFLow_Present_Fail_SL()
        {
            DUSTI_StopLogging testing = new DUSTI_StopLogging()
            {
                LevelsOption = "levels",
        ...
        public void Execute_Mode2_SL()
        {
            ...
            fake1.Insert(1, Convert.ToByte(0x87));
        ...
        /// </summary>
        [TestMethod]
        public void Execute_Mode2_Empty_Counts_SL()
        {
            DUSTI_StopLogging testing = new DUSTI_StopLogging()
            {
                LevelsOption = "Levels",
        ...
        /// </summary>
        [TestMethod]
        public void Execute_Mode2_ForceFlow_SL()
        {
            DUSTI_StopLogging testing = new DUSTI_StopLogging()
            {
                LevelsOption = "Levels",
        ...
        /// </summary>
        [TestMethod]
        public void Execute_Mode2_ForceFlow_Alt_site2_SL()
        {
            DUSTI_StopLogging testing = new DUSTI_StopLogging()
            {
                LevelsOption = "Levels",
            ...
            fake.Insert(1, Convert.ToByte(0x3));
            fake1.Insert(0, Convert.ToByte(0x1));
            fake1.Insert(1, Convert.ToByte(0x97));
            fake2.Insert(0, Convert.ToByte(0x1));
            fake2.Insert(1, Convert.ToByte(0x65));
            var sequence = new MockSequence();
        ...
        /// </summary>
        [TestMethod]
        public void Execute_Mode2_SL_Fail()
        {
            DUSTI_StopLogging testing = new DUSTI_StopLogging()
            {
                LevelsOption = "Levels",
