...
namespace VminTC.UnitTest
{
    ...
    [TestClass]
    public class NoRecoveryMode_UnitTest : NoRecoveryMode
    {
        private Mock<IConsoleService> consoleServiceMock;

        /// <summary>
        /// Initializes a new instance of the <see cref="NoRecoveryMode_UnitTest"/> class.
        /// </summary>
        public NoRecoveryMode_UnitTest()
        ...
        /// </summary>
        [TestMethod]
        public void UpdateRecoveryTrackers_Pass()
        {
            var searchResults = default(SearchResults);
            searchResults.TestResultsBits = new List<BitArray> { "0".ToBitArray() };
            var result = this.UpdateRecoveryTrackers(searchResults, null, false);
        ...
        /// </summary>
        [TestMethod]
        public void UpdateRecoveryTrackers_Force_Fail()
        {
            var testBits = "1000".ToBitArray();
            var searchResults = new SearchResults
            {
            ...
            var tracker = new Mock<IDieRecovery>(MockBehavior.Default);
            tracker.Setup(o => o.UpdateTrackingStructure(searchResults.RulesResultsBits, new BitArray(4, false), testBits, UpdateMode.Merge, true))
                .Returns(false);
            var result = this.UpdateRecoveryTrackers(searchResults, tracker.Object, true);
        ...
        /// </summary>
        [TestMethod]
        public void GetPort_NoDownbin_Port1()
        {
            var testBits = "0000".ToBitArray();
            var searchResults = new SearchResults
            {
                FailedRules = false,
                FailedSearch = false,
        ...
        /// </summary>
        [TestMethod]
        public void GetPort_Downbin_Port2()
        {
