...
namespace VminTC.UnitTest
{
    ...
    [TestClass]
    public class RecoveryPortMode_UnitTest : RecoveryPortMode
    {
        private Mock<IConsoleService> consoleServiceMock;

        /// <summary>
        /// Initializes a new instance of the <see cref="RecoveryPortMode_UnitTest"/> class.
        /// </summary>
        public RecoveryPortMode_UnitTest()
        ...
        /// </summary>
        [TestMethod]
        public void UpdateRecoveryTrackers_FailedSearchPassedRules_Skip()
        {
            var testBits = "1000".ToBitArray();
            var searchResults = new SearchResults
            {
        ...
        /// </summary>
        [TestMethod]
        public void GetPort_FailedSearchPassedRules_Port3()
        {
        ...
        /// </summary>
        [TestMethod]
        public void GetPort_PassedSearchFailedRules_Port2()
        {
