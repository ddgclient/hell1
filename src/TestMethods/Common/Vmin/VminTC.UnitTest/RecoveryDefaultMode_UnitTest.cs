...
namespace VminTC.UnitTest
{
    ...
    [TestClass]
    public class RecoveryDefaultMode_UnitTest : RecoveryDefaultMode
    {
        private Mock<IConsoleService> consoleServiceMock;

        /// <summary>
        /// Initializes a new instance of the <see cref="RecoveryDefaultMode_UnitTest"/> class.
        /// </summary>
        public RecoveryDefaultMode_UnitTest()
        ...
        /// </summary>
        [TestMethod]
        public void UpdateRecoveryTrackers_FailedUpdate_Fail()
        {
            var testBits = "1000".ToBitArray();
            var searchResults = new SearchResults
            {
        ...
        /// </summary>
        [TestMethod]
        public void GetPort_FailedSearchPassedRules_Port2()
        {
            var testBits = "1000".ToBitArray();
            var searchResults = new SearchResults
            {
