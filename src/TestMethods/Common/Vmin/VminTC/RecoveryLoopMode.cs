...
namespace VminTC
{
    ...
    /// </summary>
    public class RecoveryLoopMode : RecoveryDefaultMode
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecoveryLoopMode"/> class.
        /// </summary>
        /// <param name="console">Console service used to print debug messages. Either Prime.Services.ConsoleService or null.</param>
        public RecoveryLoopMode(IConsoleService console)
            : base(console)
        {
        }
        ...
        public override bool HasToRepeatSearch(ref SearchResults searchResults, IPinMap pinMap, IDieRecovery tracker, string recoveryOptions, bool bitsDecodeFromVoltages = true)
        {
            ...
            if (searchResults.FailedRules || !searchResults.FailedSearch || lastSearchResultData.RepetitionCount >= searchResults.MaxRepetitionCount)
            {
                return false;
            }
