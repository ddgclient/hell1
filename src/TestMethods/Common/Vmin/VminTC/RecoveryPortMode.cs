...
namespace VminTC
{
    ...
    /// </summary>
    public class RecoveryPortMode : RecoveryDefaultMode
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecoveryPortMode"/> class.
        /// </summary>
        /// <param name="console">Console service used to print debug messages. Either Prime.Services.ConsoleService or null.</param>
        public RecoveryPortMode(IConsoleService console)
            : base(console)
        {
        }
        ...
        public override bool UpdateRecoveryTrackers(SearchResults searchResults, IDieRecovery tracker, bool forceUpdate = false)
        {
            ...
            if (!forceUpdate && searchResults.FailedRules)
            {
