...
namespace TosTriggersCallbacks
{
    ...
    /// <summary>
    /// Defines TosTriggersCallbacks options.
    /// </summary>
    public class TosTriggersCallbacksOptions
    {
        /// <summary>
        /// Gets or sets type of callback.
        /// </summary>
        [Option("type", Required = true, HelpText = "Supported types: SetPinAttributes.")]
        ...
        /// </summary>
        [Option("settings", Required = true, HelpText = "<index1>:<pin1>:<attribute1>:<value1> ... <indexN>:<pinN>:<attributeN>:<valueN>")]
